...
export default function ProjectCard({ project }) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Link href={`/projects/${project.id}`} className="block group h-full glass-panel rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300 relative">
